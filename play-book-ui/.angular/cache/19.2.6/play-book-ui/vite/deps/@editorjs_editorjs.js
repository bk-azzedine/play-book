...
function Qn(n, e = () => {
  ...
  return __async(this, null, function* () {
    function o(i, s, r) {
      return __async(this, null, function* () {
        try {
          yield i.function(i.data), yield s(wo(i.data) ? {} : i.data);
        } catch {
          r(wo(i.data) ? {} : i.data);
        }
      });
...
var E = class _E {
  ...
  constructor({
    ...
    }, this.mutableListenerIds = [], new.target === _E) throw new TypeError("Constructors for abstract class Module are not allowed.");
...
var ce = class _ce {
  ...
  constructor(e) {
    this.iterator = null, this.activated = false, this.flipCallbacks = [], this.onKeyDown = (t) => {
      if (this.isEventReadyForHandling(t)) switch (_ce.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode) {
        case y.TAB:
...
var Jo = class extends Oe {
  ...
  constructor(e, t = {}) {
    super(), this.params = e, this.itemsRenderParams = t, this.listeners = new _e(), this.messages = {
      ...
      search: "Search"
    }, this.items = this.buildItems(e.items), e.messages && (this.messages = __spreadValues(__spreadValues({}, this.messages), e.messages)), this.nodes = {}, this.nodes.popoverContainer = d.make("div", [P.popoverContainer]), this.nodes.nothingFoundMessage = d.make("div", [P.nothingFoundMessage], {
...
var ms = class extends E {
  ...
  getTunesItems(e, t, o) {
    return __async(this, null, function* () {
      ...
      const s = Array.from(this.Editor.Tools.blockTools.values()), a = (yield Yo(e, s)).reduce((l, c) => (c.toolbox.forEach((u) => {
        l.push({
          icon: u.icon,
...
var Ct = class an extends Oe {
  ...
  insertNewBlock(e, t) {
    return __async(this, null, function* () {
      ...
      let r;
      if (t) {
        const l = yield this.api.blocks.composeBlockData(e);
        r = Object.assign(l, t);
      }
...
var Bs = class extends E {
  ...
  make() {
    return __async(this, null, function* () {
      ...
      const t = d.make("div"), o = d.text(z.ui(K.ui.blockTunes.toggler, "Click to tune")), i = yield xs("Slash", "/");
...
var Cs = class extends E {
  ...
  open() {
    return __async(this, null, function* () {
      ...
      const e = yield this.getPopoverItems();
      this.popover = new hs({
        items: e,
        scopeElement: this.Editor.API.methods.ui.nodes.redactor,
        messages: {
  ...
  getPopoverItems() {
    return __async(this, null, function* () {
      ...
      let t = 0;
      for (const [o, i] of this.tools) {
        const s = yield i.render(), r = this.getToolShortcut(o.name);
        if (r !== void 0) try {
        ...
        [s].flat().forEach((c) => {
          ...
          if (d.isElement(c)) {
            const g = __spreadProps(__spreadValues({}, u), {
              element: c,
              type: _.Html
            });
            ...
            e.push(g);
          } else if (c.type === _.Html) e.push(__spreadProps(__spreadValues(__spreadValues({}, u), c), {
            type: _.Html
          }));
            ...
            const g = __spreadProps(__spreadValues(__spreadValues({}, u), c), {
              type: _.Default
            });
...
var na = class extends E {
  ...
  arrowRightAndDown(e) {
    ...
    const {
      currentBlock: o
    } = this.Editor.BlockManager, s = ((o == null ? void 0 : o.currentInput) !== void 0 ? Re(o.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
  ...
  arrowLeftAndUp(e) {
    ...
    const {
      currentBlock: t
    } = this.Editor.BlockManager, i = ((t == null ? void 0 : t.currentInput) !== void 0 ? Ne(t.currentInput) : void 0) || this.Editor.BlockSelection.anyBlockSelected;
...
var ra = class extends E {
  ...
  mergeBlocks(e, t) {
    return __async(this, null, function* () {
      ...
      if (e.name === t.name && e.mergeable) {
        ...
        const i = yield t.exportDataAsString(), s = Z(i, e.tool.sanitizeConfig);
  ...
  convert(e, t, o) {
    return __async(this, null, function* () {
      ...
      const r = yield e.exportDataAsString(), a = Z(r, s.sanitizeConfig);
...
var Ye = class _Ye extends E {
  ...
  navigatePrevious(e = false) {
    ...
    const {
      previousInput: i,
      currentInput: s
    } = t, r = s !== void 0 ? Ne(s) : void 0, a = e || r || !t.focusable;
...
var Rn = class Dn extends E {
  ...
  processDataTransfer(e, t = false) {
    return __async(this, null, function* () {
      ...
      !h.trim() || h.trim() === a || !d.isHTMLString(h) ? yield this.processText(a) : yield this.processText(h, true);
    });
  }
  /**
  ...
  processText(e, t = false) {
    return __async(this, null, function* () {
      ...
      s.map((l, c) => __async(this, null, function* () {
        return this.insertBlock(l, c === 0 && a);
  ...
  processFile(e) {
    return __async(this, null, function* () {
      const t = Jn(e), o = Object.entries(this.toolsFiles).find(([r, {
        mimeTypes: a,
        extensions: l
      }]) => {
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags), s = e, {
      tool: r
    } = this.toolsTags[s.tagName] || {}, a = this.tagsByTool[r == null ? void 0 : r.name] || [], l = i.includes(s.tagName), c = d.blockElements.includes(s.tagName.toLowerCase()), u = Array.from(s.children).some(({
      tagName: p
    }) => i.includes(p) && !a.includes(p)), h = Array.from(s.children).some(({
      tagName: p
...
var Be = class _Be extends E {
  ...
  startSelection(e, t) {
    ...
    const s = [`.${R.CSS.content}`, `.${this.Editor.Toolbar.CSS.toolbar}`, `.${this.Editor.InlineToolbar.CSS.inlineToolbar}`], r = o.closest("." + this.Editor.UI.CSS.editorWrapper), a = s.some((l) => !!o.closest(l));
  ...
  genHTML() {
    const {
      UI: e
    } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = d.make("div", _Be.CSS.overlay, {}), i = d.make("div", _Be.CSS.overlayContainer, {}), s = d.make("div", _Be.CSS.rect, {});
  ...
  save() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const s = yield Promise.all(i), r = yield yt(s, (a) => t.blockTools.get(a).sanitizeConfig);
...
var Fn = class {
  ...
  render() {
    return __async(this, null, function* () {
      ...
      if (t === void 0) return [];
      const o = this.toolsAPI.getBlockTools(), i = yield Yo(t, o);
      ...
      }, []), r = yield t.getActiveToolboxEntry(), a = r !== void 0 ? r.icon : Go, l = !be();
      return {
        icon: a,
        name: "convert-to",
        hint: {
...
var xa = class {
   ...
   */
  get(e) {
    const _a2 = this.config[e], {
      class: t,
      isInternal: o = false
    } = _a2, i = __objRest(_a2, [
      "class",
      "isInternal"
    ]), s = this.getConstructor(t), r = t[mt.IsTune];
    return new s({
      name: e,
      constructable: t,
      config: i,
...
var _a = class {
  ...
  validate() {
    ...
    if (te(t) && !d.get(t)) throw Error(`element with ID «${t}» is missing. Pass correct holder's ID.`);
    if (t && D(t) && !d.isElement(t)) throw Error("«holder» value must be an Element node");
  }
  /**
   * Initializes modules:
