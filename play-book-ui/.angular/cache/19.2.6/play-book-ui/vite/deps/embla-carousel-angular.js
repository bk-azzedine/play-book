...
// node_modules/embla-carousel-angular/fesm2022/embla-carousel-angular.mjs
var EMBLA_OPTIONS_TOKEN = new InjectionToken("embla global options", {
  factory: () => void 0
});
...
function throttleDistinct(duration, equals = (a, b) => a === b) {
  return (source) => {
    return source.pipe(map((x) => {
      ...
      return diff > duration || diff < duration && !isSame ? __spreadProps(__spreadValues({}, curr), {
        keep: true
...
var EmblaCarouselDirective = class _EmblaCarouselDirective {
  constructor() {
  ...
  listenEvents() {
    ...
    eventsThrottler$.pipe(throttleDistinct(this.eventsThrottleTime()), takeUntilDestroyed(this._destroyRef)).subscribe((eventName) => {
  ...
  static {
    this.ɵfac = function EmblaCarouselDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _EmblaCarouselDirective)();
    };
  }
  static {
    this.ɵdir = ɵɵdefineDirective({
      type: _EmblaCarouselDirective,
      selectors: [["", "emblaCarousel", ""]],
      inputs: {
        options: [1, "options"],
        plugins: [1, "plugins"],
        subscribeToEvents: [1, "subscribeToEvents"],
        eventsThrottleTime: [1, "eventsThrottleTime"]
      },
      outputs: {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmblaCarouselDirective, [{
    type: Directive,
    args: [{
...
//# sourceMappingURL=embla-carousel-angular.js.map
